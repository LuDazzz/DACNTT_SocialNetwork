...
namespace SocialNetworkAPI.Migrations
{
    ...
    [Migration("20250221160653_AddjustDbCOnt")]
    partial class AddjustDbCOnt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialNetworkAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 15,
                            DateTimeCreate = new DateTime(2025, 2, 21, 23, 6, 53, 779, DateTimeKind.Local).AddTicks(8553),
                            Email = "admin@example.com",
                            FriendsCount = 0,
                            IsAdmin = true,
                            IsOnline = false,
                            IsPrivate = false,
                            LastLogin = new DateTime(2025, 2, 21, 23, 6, 53, 779, DateTimeKind.Local).AddTicks(8563),
                            Password = "admin123",
                            Username = "admin"
                        });
                });
