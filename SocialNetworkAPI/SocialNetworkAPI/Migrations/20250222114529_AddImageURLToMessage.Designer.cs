...
namespace SocialNetworkAPI.Migrations
{
    ...
    [Migration("20250222114529_AddImageURLToMessage")]
            ...
            modelBuilder.Entity("SocialNetworkAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 15,
                            DateTimeCreate = new DateTime(2025, 2, 22, 18, 45, 29, 410, DateTimeKind.Local).AddTicks(3716),
                            Email = "admin@example.com",
                            FriendsCount = 0,
                            IsAdmin = true,
                            IsOnline = false,
                            IsPrivate = false,
                            LastLogin = new DateTime(2025, 2, 22, 18, 45, 29, 410, DateTimeKind.Local).AddTicks(3726),
                            Password = "admin123",
                            Username = "admin"
                        });
                });
